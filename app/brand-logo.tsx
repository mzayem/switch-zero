...
const lockupLogoBySurface: Record<LogoSurface, LogoAsset> = {
  teal: {
    src: "/assets/switchzero-logo-teal-lockup.png",
    width: 720,
    height: 84,
  },
  white: {
    src: "/assets/switchzero-logo-white-lockup.png",
    width: 709,
    height: 83,
  },
};
...
const roundLogoBySurface: Record<LogoSurface, LogoAsset> = {
  ...
  white: {
    src: "/assets/switchzero-logo-white.png",
    width: 1080,
    height: 1080,
  },
};
...
export function BrandLogo({
  ...
  return (
    <span
      className={`brand-lockup brand-lockup--${surface} ${className}`.trim()}
    >
      <Image
...
export function RoundBrandLogo({
  className = "",
  surface = "teal",
}: {
  className?: string;
  ...
  return (
    <span
      className={`round-brand-logo round-brand-logo--${surface} ${className}`.trim()}
    >
      <Image
